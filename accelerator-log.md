...
```json
{
  ...
  "projectName" : "tap-spring-petclinic"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [spring-petclinic->tap-spring-petclinic]
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: spring-petclinic->: tap-spring-petclin...(truncated)]
